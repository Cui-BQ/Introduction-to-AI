...
class startUI(QtWidgets.QWidget):
    ...
    def createHost(self):
        ...
        if idx == 1:
            rtn = self.openFile()
            if rtn == 1:
                QtWidgets.QMessageBox.information(self, '', 'AI File open error')
                return
            else:
                gametype = 3
        else:
    ...
    def playHuman(self):
        ...
        if 'aifile' not in globals().keys():
            QtWidgets.QMessageBox.information(self, '', 'Open AI file first!')
            return
        gametype = 1
    ...
    def playInternet(self):
        ...
        if idx >= 0:
            ...
            if rtn == -1:
                QtWidgets.QMessageBox.information(self, '', 'Host closed')
                return
            ...
            if rtn == 2:
                ...
                QtWidgets.QMessageBox.information(self, '', 'Bad status!')
            ...
            QtWidgets.QMessageBox.information(self, '', 'Select a game!')
